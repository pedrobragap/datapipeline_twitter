...
from pyspark.sql.functions import col, countDistinct, when, to_date, sum, date_format
...
if __name__ == "main":
    ...
    tweet = spark.read.json(
        "/home/pedrox/datapipeline/datalake/silver/twitter_aluraonline/tweet"
    )
    ...
    tweet.coalesce(1)\
        .write\
        .json('/home/pedrox/datapipeline/datalake/gold/twitter_insight_tweet')